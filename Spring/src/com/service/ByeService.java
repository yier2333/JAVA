...
public class ByeService implements BeanNameAware,BeanFactoryAware,ApplicationContextAware,InitializingBean,DisposableBean{
	private String name;
	
	public ByeService(){
		System.out.println("ByeService1的构造方法被执行了...实例化了一个对象");
	}
